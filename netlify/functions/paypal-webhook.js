const fetch = require('node-fetch');
     ...
     exports.handler = async function (event, context) {
       ...
       try {
         ...
         // Verify webhook (optional, enable after testing)
         /*
         ...
         */
         ...
         // Extract and sanitize angler name from custom field
         const anglerName = webhookData.resource.custom?.trim();
         if (!anglerName) {
           return {
             statusCode: 400,
             body: JSON.stringify({ message: 'No angler name provided in custom field' }),
           };
         }
